  ...
  return (
    <section className="relative min-h-[100svh] flex flex-col pt-24 lg:pt-0 overflow-hidden">
            ...
            <div className="relative mt-8 hidden sm:flex flex-row flex-wrap items-center gap-6 sm:gap-x-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-300 font-medium">Active Deployments</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                 <div className="text-white">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-300 font-medium">System Capacity</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                 <div className="text-white">
      ...
      {showWhatsAppPrompt && (
        ...
        >
          ...
          <div className="flex items-start gap-3 pr-7">
            ...
            <div>
              <p className="text-sm font-semibold">Initiate a Project Assessment</p>
              <p className="mt-1 text-sm leading-relaxed text-gray-600">
                Connect with our engineering team for site evaluation and integration planning.
              </p>
            </div>
          </div>
          <a
      ...
      <motion.a
        ...
        className="fixed bottom-8 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#7CB342] text-white shadow-2xl transition-transform hover:scale-105 hover:bg-[#689F38]"
